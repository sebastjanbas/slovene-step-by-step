    ...
    return (
        <>
            <div className="mt-10 flex flex-col lg:grid gap-8 sm:mt-16 lg:grid-cols-10 lg:grid-rows-5">
                <div id="card1" className="bg-custom-gradient-300deg px-8 py-8 gap-8 lg:col-span-6 lg:row-span-3 flex flex-col justify-around items-center shadow-lg dark:border-[1px] dark:border-gray-700 border rounded-3xl">
                    <div className="w-full flex flex-col lg:flex-row items-center">
                        <div>
                            <h2 id="card2-start" className="mt-2 text-lg font-medium tracking-tight text-white max-lg:text-center">
                                {t("bento-c1-title")}
                            </h2>
                ...
                <div id="card2" className="bg-custom-gradient-0deg px-8 py-8 lg:col-span-4 lg:row-span-3 flex flex-col justify-center items-center shadow-lg dark:border-[1px] dark:border-gray-700 border rounded-3xl">
                ...
                <div id="card3" className="bg-custom-gradient-radial px-8 py-8 h-96 lg:col-span-4 lg:row-span-2 flex flex-col justify-center items-center shadow-lg dark:border-[1px] dark:border-gray-700 border rounded-3xl">
                ...
                <div id="card4" className="bg-custom-gradient-120deg px-8 py-8 col-span-6 row-span-2 flex flex-col lg:flex-row justify-center items-center shadow-lg dark:border-[1px] dark:border-gray-700 border rounded-3xl">
                    <div>
                        <h2 className="mt-2 text-lg font-medium tracking-tight text-white max-lg:text-center">
                            {t("bento-c4-title")}
                        </h2>
                        <p id="card3-start" className="mt-2 max-w-lg text-sm/6 text-white max-lg:text-center">
                            {t("bento-c4-desc")}
                        </p>
                    </div>
                    <Lottie

                ...
                <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
                    ...
                    <div className="mt-10 flex flex-col lg:grid gap-4 sm:mt-16 lg:grid-cols-10 lg:grid-rows-10">
                        <div className="px-8 py-8 gap-8 lg:col-span-6 lg:row-span-3 flex flex-col justify-around items-center shadow-lg border rounded-3xl">
                            ...
                            <div className="flex flex-col lg:flex-row items-center gap-5">
                                ...
                                <div>
                                    ...
                                    <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                                        During this lesson you will get acquainted with our
                                        methodology, learn the details of the program and get
                        ...
                        <div className="px-8 py-8 lg:col-span-4 lg:row-span-4 flex flex-col justify-center items-center shadow-lg border rounded-3xl">
                            ...
                            <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                                Join our vibrant community of over 1,200 learners on Telegram!
                                Share experiences, ask questions, and practice Slovenian with
                                fellow students in a supportive and engaging environment.
                                <br />
                        ...
                        <div className="px-8 py-8 lg:col-span-4 lg:row-span-3 flex flex-col justify-center items-center shadow-lg border rounded-3xl">
                            ...
                            <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                                ...
                                answering your questions to providing valuable feedback, we're
                                here to make your learning journey smooth and successful.
                            </p>
                        ...
                        <div className="px-8 py-8 col-span-6 row-span-2 flex flex-col lg:flex-row justify-center items-center shadow-lg border rounded-3xl">
                            <div>
                                ...
                                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                                    ...
                                    you. Whether you're learning for travel, work, or relocation,
                                    our tailored approach ensures every lesson is relevant and
                                    effective..
                                </p>
                            </div>
                            <Lottie

...
export default function Footer() {
    ...
    return (
        <footer className="bg-white dark:bg-[#121212]  m-10">
                ...
                <div className="flex flex-row items-center gap-x-5">
                    <SocialLinks href={"#"} srOnly={"Slovene Step By Step | Facebook"}>
                        <svg
                            ...
                            viewBox="0 0 48 48"
                            className="fill-custom-light-4 dark:fill-custom-dark-4"
                    ...
                    <SocialLinks href={"#"} srOnly={"Slovene Step By Step | X"}>
                        <svg
                            width={socialLinkSize}
                            height={socialLinkSize}
                            viewBox="0 0 48 48"
            ...
            <div className="mt-10">
                <p className="text-custom-light-3 dark:text-custom-dark-3">

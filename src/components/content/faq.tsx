...
export function FAQ() {
    ...
    const Styles = {
        Title: "text-lg",
        Text: "px-1 py-3 text-light-3 dark:text-dark-3"
    }
    ...
    return (
        ...
        >
            <AccordionItem value='getting-started' className='py-2'>
                <AccordionTrigger className='w-full pt-2 text-left text-light-1 dark:text-dark-1'>
                    <div className='flex items-center justify-between'>
                        <div className={Styles.Title}>{t("q1")}</div>
                        <ChevronUp className='h-4 w-4 text-light-1 transition-transform duration-200 group-data-[expanded]:-rotate-180 dark:text-dark-1' />
                    </div>
                </AccordionTrigger>
                <AccordionContent>

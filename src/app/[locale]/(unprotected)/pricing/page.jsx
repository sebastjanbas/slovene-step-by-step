    ...
    return (
        <section className="relative isolate px-6 py-24 sm:py-32 lg:px-8">
            <div className="mx-auto max-w-4xl text-center">
                <h2 className="text-base/7 font-semibold text-custom-accent-l dark:text-custom-accent-d">{t("subtitle")}</h2>
            ...
            <div id="FAQ" className='mt-40 relative overflow-hidden py-16 sm:py-24 lg:py-32 mx-auto max-w-lg md:max-w-4xl px-6 lg:px-8'>
                <h2 className="text-4xl font-semibold tracking-tight text-custom-light-1 dark:text-custom-dark-1">{t("sec2-title")}</h2>
